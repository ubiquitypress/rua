...
urlpatterns = patterns(
   '',
   url(r'(?P<submission_type>[-\w]+)/(?P<submission_id>\d+)/add/$',
       'editorialreview.views.add_editorial_review',
       name='add_editorial_review'),
   url(r'(?P<submission_type>[-\w]+)/(?P<submission_id>\d+)/add/add_files/$',
       'editorialreview.views.add_editorial_review_files',
       name='add_editorial_review_files'),
