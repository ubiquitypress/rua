...
class EditorForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['book_editors'].label_from_instance = lambda \
            obj: "%s %s" % (obj.first_name, obj.last_name)
...
class IdentifierForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('identifier', 'value', 'displayed', 'digital_format',
                  'physical_format',)
    ...
    def clean(self):
        ...
        if digital_format and physical_format:
            raise forms.ValidationError(
                'You must select either a Digital Format, a Physical Format or Neither.')
