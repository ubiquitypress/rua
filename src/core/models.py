...
class Book(models.Model):
	...
	series = models.ForeignKey('Series', null=True, blank=True, help_text="If you are submitting this work to an existing Series please select it.")
	...
	publisher_location = models.CharField(max_length=100, null=True, blank=True, help_text='Location of publisher imprint.')
...
class EditorialReviewAssignment(models.Model):
	...
	editorial_board_results = models.ForeignKey('review.FormResult', null=True, blank=True, related_name="eb_review_form_results")
