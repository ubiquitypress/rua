...
##############################################	Fixture Tests	 ##############################################		
	...
	def test_settings_fixture(self):
		...
		self.assertEqual(number_of_settings,77)
