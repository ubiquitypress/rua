...
class ProposalReview(models.Model):
    proposal = models.ForeignKey(
        Proposal)  # TODO: Remove this as it is already linked to the book through the review round
    user = models.ForeignKey(User)
    ...
    competing_interests = models.TextField(blank=True, null=True,
                                           help_text="If any of the authors or editors have any competing interests please add them here. e.g.. 'This study was paid for by corp xyz.'")
    ...
    comments_from_editor = models.TextField(blank=True, null=True,
                                            help_text="If any editors have any comments for the reviewer")
