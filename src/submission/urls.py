...
urlpatterns = patterns('',
	...
	url(r'^book/(?P<book_id>\d+)/stage/4/$', 'submission.views.submission_four', name='submission_four'),
	url(r'^book/(?P<book_id>\d+)/stage/4/author/new/$', 'submission.views.author', name='author'),
	url(r'^book/(?P<book_id>\d+)/stage/4/author/(?P<author_id>\d+)/$', 'submission.views.author', name='author_edit'),
