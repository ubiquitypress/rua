...
class ProposalForm(forms.Form):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['selection'].choices = [(proposal_form.pk, proposal_form)
                                            for proposal_form in
                                            core_models.ProposalForm.objects.all()]
...
class DefaultNotRequiredForm(forms.Form):
    title = forms.CharField(widget=forms.TextInput, required=False,
                            label='Book Title')
    subtitle = forms.CharField(widget=forms.TextInput, required=False)
    author = forms.CharField(widget=forms.TextInput, required=False,
                             label='Submitting Author/Editor')
